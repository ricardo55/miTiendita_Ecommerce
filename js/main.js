...
const createProduct = (title, description, price, imageUrl) => {
  const url =
    "https://kodecampmitiendita-default-rtdb.firebaseio.com/products.json";
...
const getProduct = (id) => {
  const url = `https://kodecampmitiendita-default-rtdb.firebaseio.com/products/${id}.json`;
...
const getAllProducts = () => {
  const url = `https://kodecampmitiendita-default-rtdb.firebaseio.com/products.json`;
...
const updateProduct = (title, description, price, imageUrl, productId) => {
  const url = `https://kodecampmitiendita-default-rtdb.firebaseio.com/products/${productId}.json`;
